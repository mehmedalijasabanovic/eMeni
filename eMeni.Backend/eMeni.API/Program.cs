using eMeni.API;
using eMeni.API.Middleware;
using eMeni.Application;
using eMeni.Infrastructure;
using Serilog;
...
public partial class Program
{
    private static async Task Main(string[] args)
    {
        ...
        try
        {
            Log.Information("Starting eMeni API...");
        ...
        catch (Exception ex)
        {
            ...
            Log.Fatal(ex, "eMeni API terminated unexpectedly.");
        }
        finally
        {
